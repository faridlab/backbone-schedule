//! Domain policy for ScheduleEmployee aggregate
//!
...
/// Domain policy for ScheduleEmployee — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ScheduleEmployee>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ScheduleEmployeeDomainPolicy = PermitAllPolicy<ScheduleEmployee>;
